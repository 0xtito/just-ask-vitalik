...
const socials = [
  {
    name: "Twitter",
    href: "https://twitter.com/tito_cda",
  ...
  return (
    <footer className="w-screen ">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <p className="relative md:order-2 text-s text-gray-500"></p>

        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-s leading-5 text-gray-500">
            {"Based off of Vitalik Buterin's "}
            <a
              className="hover:text-gray-400 hover:cursor-pointer"
              onClick={() => window.open("https://vitalik.ca", "_blank")}
            >
              essays
            </a>
          </p>
